...
class LinkedInProvider extends AbstractClientProvider
{
    ...
    public function authenticate(TokenInterface $authenticationToken)
    {
        ...
        $tokenInformation = $this->linkedInTokenEndpoint->requestValidatedTokenInformation($credentials, $scope);
    ...
    {
        $scopes = $this->configurationManager->getConfiguration(ConfigurationManager::CONFIGURATION_TYPE_SETTINGS, 'Neos.Flow.security.authentication.providers.LinkedInOAuth2Provider.providerOptions.scopes');
